...
Students = [
    ["g1","FYCSE_A",1,"CSE","A",Subjects[0]],
    ["g2","FYCSE_B",1,"CSE","B",Subjects[0]],
    ["g3","SYCSE_A",2,"CSE","A",Subjects[1]],
    ["g4","SYCSE_B",2,"CSE","A",Subjects[1]],
    ["g5","TYCSE_A",3,"CSE","A",Subjects[2]],
    ["g6","TYCSE_B",3,"CSE","B",Subjects[2]]
]
...
class TimeTable:
    ...
    def generate_population(self):
        ...
        for year in data.Subjects:
            for s in year:
                sub = Subject()
                sub.set_subject(s["subjectID"],s["subjectName"],s["lecture_per_week"],s["tutorials_per_week"],s["practicals_per_week"],s["subjectCredits"])
        ...
        for teacher in data.Teachers:
            teach = Teacher()
            teach.set_teacher(teacher["teacherID"],teacher["teacherName"],teacher["teacherSubjects"],teacher["teacherLoad"],teacher["assignedSubjects"])
        ...
        for studentGroup in data.Students:
            s = SG()
            s.set_StudentGroup(studentGroup["Student_Group_ID"],studentGroup["Student_Group_Name"],studentGroup["Group_Year"],studentGroup["Course_Name"],studentGroup["Division"],studentGroup["Subjects_list"])
